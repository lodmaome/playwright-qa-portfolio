...
inventoryTest.describe("Inventory", () => {
  inventoryTest.describe("Shopping Flow", () => {
    ...
    inventoryTest("loads inventory page", async ({ inventoryPage }) => {
      await expect(inventoryPage.title).toHaveText("Products");
    });

    inventoryTest(
      "adds a product to the carts",
    ...
    inventoryTest("navigates to the cart page", async ({ inventoryPage }) => {
  ...
  inventoryTest.describe("Performance", () => {
    ...
    inventoryTest(
      "meets page load performance budget",
      async ({
    ...
    inventoryTest("all critical assets load successfully", async ({ page }) => {
      const failed: string[] = [];
